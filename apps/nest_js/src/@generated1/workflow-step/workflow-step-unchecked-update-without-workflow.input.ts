...
import { WorkflowReminderUncheckedUpdateManyWithoutWorkflowStepNestedInput } from '../workflow-reminder/workflow-reminder-unchecked-update-many-without-workflow-step-nested.input';
import { NullableBoolFieldUpdateOperationsInput } from '../prisma/nullable-bool-field-update-operations.input';
import { BoolFieldUpdateOperationsInput } from '../prisma/bool-field-update-operations.input';

@InputType()
export class WorkflowStepUncheckedUpdateWithoutWorkflowInput {
    ...
    @Field(() => WorkflowReminderUncheckedUpdateManyWithoutWorkflowStepNestedInput, {nullable:true})
    workflowReminders?: WorkflowReminderUncheckedUpdateManyWithoutWorkflowStepNestedInput;
