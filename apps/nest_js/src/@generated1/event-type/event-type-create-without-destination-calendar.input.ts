...
import { AvailabilityCreateNestedManyWithoutEventTypeInput } from '../availability/availability-create-nested-many-without-event-type.input';
...
@InputType()
export class EventTypeCreateWithoutDestinationCalendarInput {
    ...
    @Field(() => AvailabilityCreateNestedManyWithoutEventTypeInput, {nullable:true})
