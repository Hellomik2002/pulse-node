...
import { DestinationCalendarUncheckedCreateNestedOneWithoutEventTypeInput } from '../destination-calendar/destination-calendar-unchecked-create-nested-one-without-event-type.input';
...
@InputType()
export class EventTypeUncheckedCreateWithoutCustomInputsInput {
    ...
    @Field(() => DestinationCalendarUncheckedCreateNestedOneWithoutEventTypeInput, {nullable:true})
