...
import { AvailabilityUncheckedUpdateManyWithoutEventTypeNestedInput } from '../availability/availability-unchecked-update-many-without-event-type-nested.input';
...
@InputType()
export class EventTypeUncheckedUpdateWithoutDestinationCalendarInput {
    ...
    @Field(() => AvailabilityUncheckedUpdateManyWithoutEventTypeNestedInput, {nullable:true})
    availability?: AvailabilityUncheckedUpdateManyWithoutEventTypeNestedInput;
