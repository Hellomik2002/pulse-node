...
import { WebhookUpdateManyWithoutEventTypeNestedInput } from '../webhook/webhook-update-many-without-event-type-nested.input';
...
@InputType()
export class EventTypeUpdateWithoutDestinationCalendarInput {
    ...
    @Field(() => WebhookUpdateManyWithoutEventTypeNestedInput, {nullable:true})
    webhooks?: WebhookUpdateManyWithoutEventTypeNestedInput;
