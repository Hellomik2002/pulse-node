...
import { NestedEnumSchedulingTypeNullableWithAggregatesFilter } from './nested-enum-scheduling-type-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumSchedulingTypeNullableFilter } from './nested-enum-scheduling-type-nullable-filter.input';

@InputType()
export class EnumSchedulingTypeNullableWithAggregatesFilter {
