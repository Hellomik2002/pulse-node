...
@ArgsType()
export class FindFirstAppRoutingFormsFormResponseOrThrowArgs {
    ...
    @Field(() => [App_RoutingForms_FormResponseScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof App_RoutingForms_FormResponseScalarFieldEnum>;
}
