...
import { NestedEnumTimeUnitNullableWithAggregatesFilter } from './nested-enum-time-unit-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumTimeUnitNullableFilter } from './nested-enum-time-unit-nullable-filter.input';

@InputType()
export class EnumTimeUnitNullableWithAggregatesFilter {
