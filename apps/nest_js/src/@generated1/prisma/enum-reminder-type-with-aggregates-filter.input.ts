...
import { NestedEnumReminderTypeWithAggregatesFilter } from './nested-enum-reminder-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumReminderTypeFilter } from './nested-enum-reminder-type-filter.input';

@InputType()
export class EnumReminderTypeWithAggregatesFilter {
