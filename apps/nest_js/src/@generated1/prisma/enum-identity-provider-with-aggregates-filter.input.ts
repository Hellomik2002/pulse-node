...
import { NestedEnumIdentityProviderWithAggregatesFilter } from './nested-enum-identity-provider-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumIdentityProviderFilter } from './nested-enum-identity-provider-filter.input';

@InputType()
export class EnumIdentityProviderWithAggregatesFilter {
