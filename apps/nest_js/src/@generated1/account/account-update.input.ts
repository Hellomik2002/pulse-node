...
import { UserUpdateOneWithoutAccountsNestedInput } from '../user/user-update-one-without-accounts-nested.input';
...
export class AccountUpdateInput {
    ...
    @Field(() => UserUpdateOneWithoutAccountsNestedInput, {nullable:true})
