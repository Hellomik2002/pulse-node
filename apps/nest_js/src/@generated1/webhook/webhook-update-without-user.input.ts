...
import { EventTypeUpdateOneWithoutWebhooksNestedInput } from '../event-type/event-type-update-one-without-webhooks-nested.input';
import { AppUpdateOneWithoutWebhookNestedInput } from '../app/app-update-one-without-webhook-nested.input';

@InputType()
export class WebhookUpdateWithoutUserInput {
    ...
    @Field(() => EventTypeUpdateOneWithoutWebhooksNestedInput, {nullable:true})
    eventType?: EventTypeUpdateOneWithoutWebhooksNestedInput;
