...
import { VerifiedNumberUncheckedUpdateManyWithoutUserNestedInput } from '../verified-number/verified-number-unchecked-update-many-without-user-nested.input';
import { HostUncheckedUpdateManyWithoutUserNestedInput } from '../host/host-unchecked-update-many-without-user-nested.input';

@InputType()
export class UserUncheckedUpdateWithoutDestinationCalendarInput {
    ...
    @Field(() => VerifiedNumberUncheckedUpdateManyWithoutUserNestedInput, {nullable:true})
    verifiedNumbers?: VerifiedNumberUncheckedUpdateManyWithoutUserNestedInput;
