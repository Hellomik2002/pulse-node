...
import { ImpersonationsUncheckedCreateNestedManyWithoutImpersonatedUserInput } from '../impersonations/impersonations-unchecked-create-nested-many-without-impersonated-user.input';
...
@InputType()
export class UserUncheckedCreateWithoutDestinationCalendarInput {
    ...
    @Field(() => ImpersonationsUncheckedCreateNestedManyWithoutImpersonatedUserInput, {nullable:true})
