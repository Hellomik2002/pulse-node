...
import { App_RoutingForms_FormUpdateManyWithoutUserNestedInput } from '../app-routing-forms-form/app-routing-forms-form-update-many-without-user-nested.input';
...
@InputType()
export class UserUpdateWithoutSelectedCalendarsInput {
    ...
    @Field(() => App_RoutingForms_FormUpdateManyWithoutUserNestedInput, {nullable:true})
    routingForms?: App_RoutingForms_FormUpdateManyWithoutUserNestedInput;
