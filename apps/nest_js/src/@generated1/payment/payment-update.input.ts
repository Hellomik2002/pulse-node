...
import { BookingUpdateOneWithoutPaymentNestedInput } from '../booking/booking-update-one-without-payment-nested.input';
...
export class PaymentUpdateInput {
    ...
    @Field(() => BookingUpdateOneWithoutPaymentNestedInput, {nullable:true})
