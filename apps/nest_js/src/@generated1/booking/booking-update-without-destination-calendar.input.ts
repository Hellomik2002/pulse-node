...
import { UserUpdateOneWithoutBookingsNestedInput } from '../user/user-update-one-without-bookings-nested.input';
...
@InputType()
export class BookingUpdateWithoutDestinationCalendarInput {

    @Field(() => StringFieldUpdateOperationsInput, {nullable:true})
    uid?: StringFieldUpdateOperationsInput;

    @Field(() => UserUpdateOneWithoutBookingsNestedInput, {nullable:true})
