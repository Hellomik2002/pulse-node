...
import { PaymentCreateNestedManyWithoutBookingInput } from '../payment/payment-create-nested-many-without-booking.input';
...
@InputType()
export class BookingCreateWithoutDestinationCalendarInput {
    ...
    @Field(() => PaymentCreateNestedManyWithoutBookingInput, {nullable:true})
